|id|minigame_scheme_id|event_id|release_conditions_1|conditions_id_1|first_time_story_id|display_condition_type|display_condition_id|result_chat_condition_id|score_unit|is_enabled_zero_score|
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
